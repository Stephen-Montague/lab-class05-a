...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let sumToString = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumTotal} is their sum.`;
  return [sumTotal, sumToString];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let productToString = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${product}.`;
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  let productToString = `The numbers ${dynamicArray} have a product of ${product}.`;
  return[product, productToString];
}
